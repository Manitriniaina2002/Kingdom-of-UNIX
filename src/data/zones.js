...
export const ZONES = {
  village: {
    ...
    story: {
      intro: 'Welcome, young traveler! The Village of Files is where all adventurers begin their journey. Here, the wise Elder Directory will teach you the ancient art of navigation.',
      character: 'Elder Directory',
      characterEmoji: '🧙‍♂️',
    },
  },
  cave: {
