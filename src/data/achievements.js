...
// Level Definitions
export const LEVELS = [
  { level: 1, xpRequired: 0, title: 'Terminal Newbie', icon: 'lvl1' },
  { level: 2, xpRequired: 100, title: 'Script Seeker', icon: 'lvl2' },
  { level: 3, xpRequired: 250, title: 'Command Learner', icon: 'lvl3' },
  { level: 4, xpRequired: 500, title: 'Directory Walker', icon: 'lvl4' },
  { level: 5, xpRequired: 800, title: 'File Handler', icon: 'lvl5' },
  { level: 6, xpRequired: 1200, title: 'Permission Novice', icon: 'lvl6' },
  { level: 7, xpRequired: 1700, title: 'Process Watcher', icon: 'lvl7' },
  { level: 8, xpRequired: 2300, title: 'Pipe Apprentice', icon: 'lvl8' },
  { level: 9, xpRequired: 3000, title: 'Shell Crafter', icon: 'lvl9' },
  { level: 10, xpRequired: 4000, title: 'UNIX Knight', icon: 'lvl10' },
  { level: 11, xpRequired: 5200, title: 'Terminal Warrior', icon: 'lvl11' },
  { level: 12, xpRequired: 6600, title: 'Command Sage', icon: 'lvl12' },
  { level: 13, xpRequired: 8200, title: 'System Guardian', icon: 'lvl13' },
  { level: 14, xpRequired: 10000, title: 'Kernel Knight', icon: 'lvl14' },
  { level: 15, xpRequired: 12500, title: 'Root Master', icon: 'lvl15' },
  { level: 16, xpRequired: 15500, title: 'Shell Legend', icon: 'lvl16' },
  { level: 17, xpRequired: 19000, title: 'UNIX Grandmaster', icon: 'lvl17' },
  { level: 18, xpRequired: 23000, title: 'System Overlord', icon: 'lvl18' },
  { level: 19, xpRequired: 28000, title: 'Terminal Titan', icon: 'lvl19' },
  { level: 20, xpRequired: 35000, title: 'King of UNIX', icon: 'lvl20' },
];
